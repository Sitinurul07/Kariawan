...
<form action="inputkaryawan.php" class="form-horizontal" method="POST" name="forminputkaryawan" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-md-5">
			<input type="file" class="btn btn-info" id="foto">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-3">
			<input type="text" class="form-control" id="tmplahir" placeholder="Masukan Tempat Lahir">
		</div>
	</div>
	<div class="form-group">
		...
		<label class="col-md-2 control-label">Golongan Darah</label>
			<div class="radio col-md-1">
				<label for="a" class="control-label">
					<input type="radio" name="jk" id="a" value="a" checked>
				A</label>
			</div>
			<div class="radio col-md-1">
				<label for="b" class="control-label">
					<input type="radio" name="jk" id="b" value="b">
				B</label>
			</div>
			<div class="radio col-md-1">
				<label for="ab" class="control-label">
					<input type="radio" name="jk" id="ab" value="ab">
				AB</label>
			</div>
			<div class="radio col-md-1">
				<label for="o" class="control-label">
					<input type="radio" name="jk" id="o" value="o">
				O</label>
			</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-3">
			<input type="text" class="form-control" id="notlp" placeholder="Masukan No Telepon">
		</div>
	</div>
	<div class="form-group">
