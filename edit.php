...
<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><?php if (empty($foto)) 
				...
				?><br /><br /><br /><br /><br /><br /><br /><?php=$namafoto?><br><br><input type="file" name="foto" size="49"/></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td><input type="submit" name="Edit" class="btn btn-info" value="Edit Data">&nbsp;&nbsp;
				<input type="button" value="Cancel" class="btn btn-info" onclick=location.href="index.php?page=lihat" title="kembali ke form edit data"></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td height="32">&nbsp;</td>
